<script lang="tsx">
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const backLoginI18n = t('system.exception.backLogin');
      const backHomeI18n = t('system.exception.backHome');

      unref(statusMapRef).set(ExceptionEnum.PAGE_NOT_ACCESS, {
        title: '403',
        status: `${ExceptionEnum.PAGE_NOT_ACCESS}`,
        subTitle: t('system.exception.subTitle403'),
      ...
      unref(statusMapRef).set(ExceptionEnum.PAGE_NOT_FOUND, {
        ...
        subTitle: t('system.exception.subTitle404'),
        btnText: props.full ? backLoginI18n : backHomeI18n,
        handler: () => (props.full ? go(PageEnum.BASE_LOGIN) : go()),
      });
      ...
      unref(statusMapRef).set(ExceptionEnum.ERROR, {
        ...
        subTitle: t('system.exception.subTitle500'),
        btnText: backHomeI18n,
        handler: () => go(),
      });

      unref(statusMapRef).set(ExceptionEnum.PAGE_NOT_DATA, {
        title: t('system.exception.noDataTitle'),
        subTitle: '',
      ...
      unref(statusMapRef).set(ExceptionEnum.NET_WORK_ERROR, {
        title: t('system.exception.networkErrorTitle'),
        subTitle: t('system.exception.networkErrorSubTitle'),
        btnText: t('common.redo'),
        handler: () => redo(),
        icon: netWorkSvg,
      });
