...
<script lang="ts" setup>
  ...
  import SessionTimeoutLogin from '@/views/system/common/login/SessionTimeoutLogin.vue';

  import { useMultipleTabSetting } from '@/hooks/setting/useMultipleTabSetting';

  defineOptions({ name: 'LayoutFeatures' });

  const LayoutLockPage = createAsyncComponent(() => import('@/views/system/common/lock/index.vue'));
